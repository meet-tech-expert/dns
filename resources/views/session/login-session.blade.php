            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Sign in with<br></p>
                  <div class="row px-xl-5 px-sm-4 px-3">
                    <div class="col-3 ms-auto px-1">
                      <a class="btn btn-outline-light w-100" href="{{ url('login/facebook') }}">
                    ...
                    <div class="col-3 px-1">
                      <a class="btn btn-outline-light w-100" href="{{ url('login/twitter') }}">

                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="32px" enable-background="new 0 0 1668.56 1221.19" viewBox="0 0 1668.56 1221.19" id="twitter-x">
